...
\FunctionTok{plot}\NormalTok{(}\FunctionTok{density}\NormalTok{(data))}
\end{Highlighting}
\end{Shaded}

\includegraphics{demo_4_files/figure-latex/cars-1.pdf}
...
\includegraphics{demo_4_files/figure-latex/pressure-1.pdf}
...
\includegraphics{demo_4_files/figure-latex/unnamed-chunk-1-1.pdf}
