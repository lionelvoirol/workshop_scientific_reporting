...
- Introduction to the `xaringan` `R` package for producing scientifc slides presentation with $\LaTeX$ equations, code, graphs, references and interactive elements.
