---
title: "Scientific reporting with the `R` ecosystem"
...
BibOptions(check.entries = FALSE, 
           ...
           hyperlink = FALSE, 
           dashed = FALSE)
myBib <- ReadBib("docs/assets/example.bib", check = FALSE)
```
...
- Introduction to the `xaringan` `R` package for producing scientific slides presentation with $\LaTeX$ equations, code, graphs, references and interactive elements.

- Introduction to the use of `Git` and `GitHub` for collaborative writing/programming and Mathpix to easily copy Math equation.

- Introduction to advanced integration and customization options
...
- [`R` `r icon_style(fontawesome$brands$"r-project", fill="#165CAA")`](https://www.r-project.org/)

- [`RStudio`](https://www.rstudio.com/)

- [`RMarkdown`](https://rmarkdown.rstudio.com/)

- [`xaringan` `R` package](https://github.com/yihui/xaringan)

- [`GitHub`](https://github.com/) `r fontawesome$brands$github`
...
- Tools for Scientific reporting
  - `xaringan` for scientific slideshows
  - `GitHub`
...
.center[![:scale 32%](assets/repro_2.jpg)]
...
Since compiling a `.Rmd` document in `.pdf` requires a $\LaTeX$ installation, and that you may not all have $\LaTeX$ already installed, we will mostly consider compilation in `.html` for the presentation. (*Note that installing $\LaTeX$ and linking it to `RStudio` is a simple and straightforward procedure and that most elements discussed today can be included in `.pdf`-compiled `RMarkdown` document*.)
...
```{r,eval =F}
`r icon_style(fontawesome("rocket", style = "solid"), scale = 2, fill = "red")`
```
...
For more info see [the `emo` GitHub repo](https://github.com/hadley/emo) and [the `icons` GitHub repo](https://github.com/mitchelloharawild/icons).


---

# The `RMarkdown playground` web app
...
.center[In group, try to compile a `.Rmd` document with a title, author, date, compiled `R` code, and a statistical graph (e.g. boxplot, histogram, barplots, etc) of your choice. You can also try to add other elements discussed (tables, images, etc). Show it to the audience if interested!]
...
`xaringan` is an R package for creating scientific slideshows with [`remark.js`](https://remarkjs.com) through `RMarkdown`.

`xaringan` provide the ability to easily include a large number of elements (text, images, code, $\LaTeX$ equations, videos, `html` elements) and offer the possibility of complex customization with `css` and `javascript`. 



.center[![:scale 20%](assets/xaringan.png)]

&nbsp;

Find more informations on the [`xaringan` wiki](https://github.com/yihui/xaringan/wiki) and on the [`xaringan` GitHub repository](https://github.com/yihui/xaringan).
...
<div align="center">
<iframe id="xaringan_intro"
    title="Introduction to xaringan"
    width="900"
    height="440"
    src="https://slides.yihui.org/xaringan/#1">
</iframe>
...
<iframe id="xaringan_ex"
    ...
    width="900"
    height="440"
    src="https://raw.githack.com/stephaneguerrier/data_analytics/master/Lecture1.html#1">
</iframe>
...
---
# GitHub for collaborative writing/programming `r fontawesome$brands$github`
...
```{r, eval=T, echo=F, message=F, warning=F, fig.align="center", fig.height=6}
rm(list=ls())
library(plotly)
library(reshape2)
# example from https://stackoverflow.com/questions/38331198/add-regression-plane-to-3d-scatter-plot-in-plotly
...
# Customization and templates for `.pdf` compilation
...
---
# Templates for `.pdf` compilation of a `.Rmd`
...
# Themes  for `.html` compilation of a `.Rmd`
...
.pull-left[
.center[![:scale 50%](assets/theme_1.png)]
]


.pull-right[
.center[![:scale 70%](assets/theme_2.png)]
]

---
# Themes  for `xaringan` presentations

The excellent [`xaringanthemer R` package](https://pkg.garrickadenbuie.com/xaringanthemer/index.html) provides the ability to easily customize your `xaringan` presentation and proposes various built-in themes.



.center[![:scale 50%](assets/theme_xar_1.png)]




.center[![:scale 50%](assets/theme_xar_2.png)]
...
- [Xaringan GitHub repo](https://github.com/yihui/xaringan)

- [Sharing Your Work with xaringan](https://spcanelon.github.io/xaringan-basics-and-beyond/)
...
.white[`r fontawesome(name = "images")` slides ]
</a>

<a href="mailto:lionel.voirol@unige.ch">
.white[`r fontawesome(name = "paper-plane")` Lionel.Voirol@unige.ch]
</a>

<a href="https://github.com/lionelvoirol">
.white[`r fontawesome$brands$github` @lionelvoirol]
</a>
