...
For more info see [the emo repo](https://github.com/hadley/emo).
...
`xaringan` is an R package for creating slideshows with `remark.js` through `RMarkdown`. 

&nbsp;

.center[![:scale 25%](assets/xaringan.png)]

Find more informations [here](https://github.com/yihui/xaringan).
...
---
# GitHub for collaborative writing/programming
